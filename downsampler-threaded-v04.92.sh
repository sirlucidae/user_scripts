...
#
#      Uses SoX with per-file multi-threading when "env_parallel", part of GNU Parallel, is detected, or with a
#      single thread when it isn't.
#
...
# runtime options -- letters left: aA gG jJ kK lL qQ xX yY zZ
while true ;do
	case "$1" in
		-b|--progress-bar)
			use_progress_bar="1"
